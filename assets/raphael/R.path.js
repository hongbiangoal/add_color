...
var PathDefine = {
    ...
    getBbox: function () {
        ...
        console.log("---lhb "+this._commands.bbox);
    ...
    getWorldBbox: function () {
        ...
        console.log("---lhb "+this._commands.worldBbox);
    ...
    center: function (x, y) {
        ...
        console.log("---lhb  bbox="+bbox.width+"--x="+bbox.x+"---height="+bbox.height+"--y="+bbox.y);
    ...
    _analysis: function () {
        ...
        for (var i = 0, ii = curves.length; i < ii; i++) {
            ...
            for (var j = 0, jj = subCurves.length; j < jj; j++) {
                ...
                if(j===0){
                    subPoints.push(curve[0]);
                    subPoints.push(curve[1]);
                }
